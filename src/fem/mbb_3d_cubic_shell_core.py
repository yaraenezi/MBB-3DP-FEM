"""Full-upright MBB shell/core screening model for sparse cubic infill.
...
The core is represented by an isotropic cellular-solid screening law
E_core / E_PLA = relative_density ** exponent. Pattern pitch and density are
verified separately from the archived Bambu Studio G-code.
"""
...
def create_stiffness_scale(
    ...
    core_scale = infill_density**exponent
...
def main() -> None:
    ...
    run_dir = args.output_root / (
        ...
        + f"_mbb_cubic_{case_percent:02d}_full_upright"
    )
    ...
    domain.name = f"full_upright_cubic_{case_percent:02d}"
    ...
    problem = LinearProblem(
        ...
        petsc_options_prefix=f"mbb_cubic_{case_percent:02d}_",
        petsc_options={
            "ksp_type": "cg",
            "pc_type": "gamg",
            "ksp_rtol": 1.0e-10,
    ...
    create_plot(
        ...
        args.plot_scale,
        (
            f"Full upright MBB cubic {case_percent}%\n"
    ...
    results = {
        "case": f"cubic_{case_percent:02d}_full_upright",
        ...
        "gcode_verified": {
            ...
            "measured_projected_line_pitch_mm": args.infill_pitch_mm,
            "road_angle_families_deg": [45.0, 105.0, 165.0],
            "wall_loops": 2,
        ...
        "model_assumptions": {
            ...
            "core_law": "E_core/E_PLA = infill_density ** core_exponent",
